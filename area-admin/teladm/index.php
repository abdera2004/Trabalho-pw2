              ...
              <tr>
                ...
                <td class="text-center">
                  <form action="process.php" method="POST">
                    ...
                    <input type="hidden" class="form-control" id="id" name="id" value="<?=$teladm[0]?>">
                ...
                <td class="text-center ">
                  <a class="dropdown-item" onclick="modalRemover(<?=$teladm[0]?>,'idDeletar')">
    ...
    <div class=" modal-dialog modal-dialog-centered">
      <div class="modal-content">
        <div class="modal-header bg-danger text-white">
          <h1 class="modal-title fs-5" id="exampleModalLabel">Excluir Telefone</h1>
